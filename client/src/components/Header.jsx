...
export default function Header() {
  return (
    <header className="glass-effect border-b border-white/30 sticky top-0 z-50 backdrop-blur-2xl">
      <div className="container mx-auto px-6 py-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-purple-600 via-pink-600 to-blue-600 p-4 rounded-2xl shadow-2xl">
                <Sparkles className="w-8 h-8 text-white animate-spin-slow" strokeWidth={2.5} />
              </div>
            </div>
            <div>
          ...
          <div className="hidden md:flex items-center space-x-3">
            <div className="flex items-center space-x-3 bg-gradient-to-r from-green-500/20 to-emerald-500/20 backdrop-blur-lg px-6 py-3 rounded-full border border-green-400/30 shadow-lg shadow-green-500/20">
              <div className="relative">
